        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <span>list Kategory</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">List Kategory</h6>
                        <a class="collapse-item" href="category">Category</a>
                        <a class="collapse-item" href="book">buku</a>
                        <a class="collapse-item" href="koleksi">kolesi Pribadi</a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Faisal 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
